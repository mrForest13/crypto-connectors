...
use protocol::public::trade::TradesMessage;
...
async fn main() {
    ...
    let mut subscription: Take<NatsStream<TradesMessage>> = connector
        .trades(exchange, market)
        .await
        .expect("Failed to get trades stream")
        .take(3);
